...
# busca los autos cuyo segundo campo sea mayor a la media de todos los autos
print("Los autos cuyo segundo campo es mayor al de la media de todos los autos son:")
for i in lista_anidada:
    if i[1] > promedio(list_tmp1):    
        print(i[0])
